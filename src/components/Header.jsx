    ...
    <main className='pb-20 sm:pt-16 md:pt-32'>
      <section className='flex flex-col pt-[150px] mx-auto px-3 sm:px-8 sm:text-cyan-600 md:text-red-500 lg:text-green-500 sm:flex-row-reverse sm:max-w-[1280px]'>
        ...
        <section className='max-w-[500px] md:ml-[5%] mx-auto px-1'>
          <h2 className='text-violet-600 font-bold text-[28px] lg:text-5xl mb-7 hover:text-slate-700'>Hi! <span className='text-slate-700 hover:text-violet-600'>I’am a frontend developed.</span></h2>
      ...
      <section id='about_me' className='items-center flex flex-col mx-5 max-w-[1280px] sm:mx-auto md:pt-32 pt-40'>
        ...
        <span className='flex sm:hover:gap-5 text-lg hover:gap-1 hover:text-violet-600 duration-200 md:mt-20 font-bold sm:text-5xl items-center text-slate-700'>
          {'<'}<h2 className='sm:text-3xl text-slate-700'> My name is Carlos Santos</h2>{'/>'}
        </span>
