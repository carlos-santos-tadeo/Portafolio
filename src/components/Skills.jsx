...
const Experience = () => {
  ...
  return (
    <main>
      ...
      <section className="px-7 relative">
        <div className="flex flex-col sm:max-w-[1034px] max-w-[280px] items-center gap-16 bg-slate-500/50 dark:bg-slate-700/60 rounded-lg py-6 my-12 mx-auto sm:flex-row sm:justify-center sm:px-3 lg:mx-auto">
          <div className="hover:shadow-violet-400 z-30 hover:shadow-lg flex flex-col justify-center text-center gap-6 bg-slate-500/80 dark:bg-slate-600/90 rounded-lg aspect-square w-[200px]">
            <span className="font-bold text-xl rounded-2xl">
              {/* {t("framework")} */}
            </span>
            <img
              className="mx-auto hover:animate-spin w-12"
              src="/images/imgNode.png"
              alt=""
            />
            <span className="rounded-2xl">{t("nodeMsj")}</span>
          </div>
          <div className="hover:shadow-violet-400 z-30 hover:shadow-lg flex flex-col justify-center text-center gap-3 bg-slate-500/80 dark:bg-slate-600/90 rounded-lg aspect-square w-[200px]">
            <span className="font-bold text-xl rounded-2xl">
              {/* {t("framework")} */}
            ...
            <img
              className="mx-auto w-[75px] hover:animate-bounce"
              src="/images/imgPostgresql.png"
              alt=""
            />
            <span className="rounded-2xl">{t("postgreMsj")}</span>
          </div>
          <div className="hover:shadow-violet-400 z-30 hover:shadow-lg flex flex-col justify-center text-center gap-6 bg-slate-500/80 dark:bg-slate-600/90 rounded-lg aspect-square w-[200px]">
            <img
              className="mx-auto hover:animate-pulse w-[50px]"
              src="/images/imgSequelize.png"
              alt=""
            />
            <span className="rounded-2xl">{t("sequelizeMsj")}</span>
          </div>
        </div>
      </section>
    </main>
