  ...
  return (
    <section id='footer' className='py-10 sm:flex sm:justify-center md:mt-20' >
      <div className='grid gap-6 justify-items-center bg-slate-500/50 rounded-2xl mx-5 py-16 sm:py-3 max-w-[800px]'>
        ...
        <div className='mb-5 flex items-center gap-3 md:gap-12'>

          <a className='w-24 md:w-28 hover:bg-slate-300 rounded-md duration-500' href="mailto:cast0277@gmail.com" target="_blank">
            <img src="/images/gmail.png" alt="" />
          </a>

          <a className='w-24 md:w-28 hover:bg-slate-300 rounded-md duration-500' href="https://github.com/carlos-santos-tadeo" target="_blank">
            <img src="/images/gitHub.png" alt="" />
          </a>

          <a className='w-24 md:w-28 hover:bg-slate-300 rounded-md duration-500' href="https://www.linkedin.com/in/carlosalbertosantostadeo/" target="_blank">
