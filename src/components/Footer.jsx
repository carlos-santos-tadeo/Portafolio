  ...
  return (
    <section className='py-10 sm:flex sm:justify-center ' >
      <div className='grid gap-6 justify-items-center bg-slate-500/50 rounded-2xl mx-5 py-16 sm:py-3 max-w-[700px]'>
        ...
        <p className='px-3 text-center sm:px-20 lg:px-28'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut cursus ac ipsum sed rhoncus. Nam euismod auctor ipsum.</p>
        <div className='mb-12'>
